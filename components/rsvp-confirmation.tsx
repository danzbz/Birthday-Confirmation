...
//       >
//         <div className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-pink-200" style={{ padding: "1.4rem" }}>
...
//             <h1 className="text-2xl font-bold text-pink-600">Olá, Jaine!</h1>
...
export function RsvpConfirmation() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      >
        <div
          className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-pink-200"
